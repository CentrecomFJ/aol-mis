<aside class="main-sidebar sidebar-light-primary elevation-4" style="min-height: 917px;">
    ...
    <a href="#" class="brand-link">
        <span class="brand-text font-weight-light"> <img src="{{ asset('images/aviationonline-logo.png') }}"
                alt="157-MIS Logo" class="img-fluid m-2"></span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    {{-- <a href="{{ route('admin.feedback.allentries') }}" class="nav-link"> --}}
                    <a href="" class="nav-link">
                ...
                @can('client_management_setting_access')
                    <li
                        class="nav-item has-treeview {{ request()->is('admin/feedbackcontact*') ? 'menu-open' : '' }} {{ request()->is('admin/transaction-types*') ? 'menu-open' : '' }} {{ request()->is('admin/income-sources*') ? 'menu-open' : '' }} {{ request()->is('admin/client-statuses*') ? 'menu-open' : '' }} {{ request()->is('admin/project-statuses*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            @can('currency_access')
                                <li class="nav-item">
                                    <a href="{{ route('admin.feedbackcontact.index') }}"
                                        class="nav-link {{ request()->is('admin/feedbackcontact') || request()->is('admin/feedbackcontact/*') ? 'active' : '' }}">
