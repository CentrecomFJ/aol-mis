...
<head>
    ...
    {{-- <link href="{{ asset('custom/daterangepicker/daterangepicker.css') }}" /> --}}
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/3.0.5/daterangepicker.css" integrity="sha512-gp+RQIipEa1X7Sq1vYXnuOW96C4704yI1n0YB9T/KqdvqaEgL6nAuTSrKufUX3VBONq/TPuKiXGLVgBKicZ0KA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link href="{{ asset('css/custom.css') }}" rel="stylesheet" />
    @yield('styles')
    <style>
    .sidebar-dark-primary {
        background-color: #3aa5c1;
    }
    </style>
</head>
        ...
        <nav class="main-header navbar navbar-expand bg-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    {{-- <a href="{{ route('admin.feedback.create') }}" class="btn btn-primary">Feedback Entry&nbsp;&nbsp;<i class="fa fa-plus-circle"></i></a> --}}
                </li> 
            </ul>
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    $(document).ready(function(){
      ...
      $('#email_addresses').select2({
            dropdownParent: $('#add-escalation-modal')
      });
    });       
    </script>
</body>
